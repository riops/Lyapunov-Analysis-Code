...
int main() {
    ...
    vector<long double> initialCondition = {19, 20, 50, 1, 0, 0, 0, 1, 0, 0, 0, 1 };

    vector<vector<long double>> spectrum = IntegrateSystem(Lorenz, initialCondition, dt, numIterations, true);
    ...
    std::string filename = "EOMLorenz_" + datetime + ".csv";
